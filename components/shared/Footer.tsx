        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mb-16">
          ...
          <motion.div variants={itemVariants} className="w-full">
            ...
            <ul className="space-y-4">
              <li>
                <Link
                  href="/catalog?page=1&sort=default&categories=6812770485ec2691c2d073d4"
                  className="text-sm text-gray-500 hover:text-gray-900 transition-colors"
                >
                  Ігрові миші ATTACK SHARK
                </Link>
              </li>
              <li>
                <Link href="/catalog?page=1&sort=default&categories=6812770585ec2691c2d073e6%2C6812770585ec2691c2d073dd" className="text-sm text-gray-500 hover:text-gray-900 transition-colors">
                  Ігрові клавіатури Ajazz
                </Link>
              </li>
              <li>
                <Link
                  href="/catalog?page=1&sort=default&categories=6812770585ec2691c2d073f8"
                  className="text-sm text-gray-500 hover:text-gray-900 transition-colors"
                >
                  Ігрові миші Ajazz
                </Link>
              ...
              <li>
                <Link
                  href="/catalog?page=1&sort=default&categories=6812770685ec2691c2d07404%2C6812770585ec2691c2d07401"
                  className="text-sm text-gray-500 hover:text-gray-900 transition-colors"
                >                  
                  Клавіатури ATTACK SHARK
                </Link>
              </li>
            </ul>
          </motion.div>
